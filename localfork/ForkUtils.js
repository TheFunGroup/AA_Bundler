...
module.exports = {
    ...
    getUserBalanceErc, createErc, logPairing, HARDHAT_FORK_CHAIN_ID_STRING, HARDHAT_FORK_CHAIN_KEY, CHAINLINK_TOKEN_AGGREGATOR_ADDRESS, HARDHAT_FORK_CHAIN_ID, RPC_URL, PRIV_KEY, PKEY, DAI_ADDR, API_KEY, USDC_ADDR, AVAX_CHAIN_ID, AVAX_RPC_URL, USDC_AVAX_ADDR, LOCALHOST_URL, AVAX_RECEIVE_PKEY
}
